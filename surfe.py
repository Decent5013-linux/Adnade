...
class SimpleBotSimulator:
    ...
    async def run_session(self):
        ...
        print(f"⏱️  Session duration: {session_duration:.1f}s (20-30s range)")
        print(f"🎯 Target click area: center at ({REF_CENTER_X:.0f}, {REF_CENTER_Y:.0f}) in 1280x720 reference")
        print("📊 Click will happen at END of session with 0.3% probability\n")
        ...
        # SESSION ENDED - now decide whether to click (0.3% chance)
        print("⏱️  Session natural duration completed")
        
        if random.random() < 0.003:  # 0.3% chance
            print("🎯 0.3% chance triggered - preparing to click...")
            ...
            print("⏹️  No click this session (99.7% no-click chance)")
    ...
    async with async_playwright() as p:
        ...
        while True:
            ...
            try:
                ...
                # Run the session (20-30 seconds of behavior, then click decision)
...
if __name__ == "__main__":
    ...
    print("⏱️  Session: 20-30 seconds of natural behavior, THEN click decision")
    print("📊 Click probability: 0.3% (only at VERY END of session)")
